...
# Import custom routers for CanChat fork
try:
    from open_webui.routers import artifacts, code, domains
    HAS_CUSTOM_ROUTERS = True
except ImportError:
    HAS_CUSTOM_ROUTERS = False
...
# Include custom routers for CanChat fork
if HAS_CUSTOM_ROUTERS:
